...
void AccessLzwDecompressor::decompress(const byte *source, byte *dest) {
...
uint16 AccessLzwDecompressor::getCode() {
...
uint32 decompressAccessDBE(const byte *source, byte **dest) {
